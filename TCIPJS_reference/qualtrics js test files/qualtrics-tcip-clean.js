/**
 * CLEAN Qualtrics Integration for TCIP Task
 * 
 * This version removes the problematic addOnUnload function and focuses on core functionality.
 * Based on your console output, the iframe is loading and communication is working!
 */
...
Qualtrics.SurveyEngine.addOnload(function() {
    ...
    iframe.onload = function() {
        ...
        setTimeout(() => {
            try {
                ...
                console.log('✅ Integration message sent to iframe');
            } catch (error) {
    ...
    window.addEventListener('message', function(event) {
        ...
        if (event.data && event.data.type === 'TCIP_COMPLETE') {
            console.log('🎉 Task completed! Processing data...');
